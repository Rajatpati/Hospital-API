...
```bash
  git clone https://github.com/Rajatpati/Hospital-api
```
...
Root Hosted Link - https://github.com/Rajatpati/Hospital-api
Routes :
...
- [@Rajat](https://github.com/Rajatpati/Hospital-api)
